$(document).ready(function(){
    ...
    function conectarUsuario(event){
        ...
        if(username){
            ...
            var socket = new SockJS("/websocket"); //SockJS ESTE ES PAPI, PARA CONCETAR CON EL WBSO..
            stompClient = Stomp.over(socket); //STOMP TAFUR AQUI ESTA PARA PROTOCOLO DE MENSAJERIA YA TU SAA
